...
int main() {
    ...
    int arrSize = sizeof(arr); // Short - это 2 байта.  Длина массива * размер элемента
    ...
    int arrCount = sizeof(arr) / sizeof(arr[0]); // то делим результат на размер 1-го элемента. Количество байт массива / на размер 1-го эл.
