...
int main() {
    ...
    vector<string> enWords = {"meet", "let", "ride", "hold", "hear", "have", "grow", 
                              "give", "get", "fight", "fall",
                              "cost", "come", "choose", "catch"};
    vector<string> ruWords = {"встречаться", "позволять", "кататься", "держать",
                            "слышать", "иметь", "расти", "давать", "получать",
                            "бороться", "падать", "стоить", "придти", "выбрать",
                            "ловить"};
