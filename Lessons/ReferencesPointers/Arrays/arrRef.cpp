...
int main() {
    ...
    cout << "Разыменование массива возвращает 1-й его эелемент: \n" << *arr << '\n';
    ...
    cout << "Размер массива в битах: " << sizeof(arr) << " бит " << &arr << '\n'; // Возвращает размер в битах
    cout << "Размер указателя: " << sizeof(ptr) << " бит " << &ptr << '\n'; // Размер указателя
    // В примере выше - фиксированный массив знает свою длину, а указатель на массив  - нет!
    cout << "Тип массива: " << typeid(arr).name() << endl; // Для компилятора массив arr всего лишь переменная int[4]
    return 0;
}
// Output
/*
